...
flags.DEFINE_integer("z_size", 2048, "size of latent (feature?) space")
flags.DEFINE_float("learning_rate_enc", 1e-4, "learning rate")
flags.DEFINE_float("learning_rate_gen", 1e-5, "learning rate")
flags.DEFINE_float("learning_rate_dis", 1e-5, "learning rate")
